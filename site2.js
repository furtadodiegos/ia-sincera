...
function H(b){this.next=(c)=> {z(b.g);b.g.g?c=F(b,b.g.g.next,c,b.g.o):(b.g.o(c),c=G(b));return c};this.throw=function(c){z(b.g);b.g.g?c=F(b,b.g.g["throw"],c,b.g.o):(A(b.g,c),c=G(b));return c};this.return=function(c){return E(b,c)};this[Symbol.iterator]=function(){return this}}function I(b){function c(h){return b.next(h)}function g(h){return b.throw(h)}return new Promise(function(h,l){function m(f){f.done?h(f.value):Promise.resolve(f.value).then(c,g).then(m,l)}m(b.next())})}
...
function g(a){a=a===void 0?document.body:a;a.querySelectorAll(l).forEach(function(d){c(d)})}function h(){b().catch(()=> {});document.fonts.ready.then(function(){requestAnimationFrame(()=> {g(document.body);(new MutationObserver((a)=> {var d=new Set;a=t(a);for(var e=a.next();!e.done;e=a.next())if(e=e.value,e.type==="childList")e.addedNodes.forEach((p)=> {p.nodeType===Node.ELEMENT_NODE&&(p.matches(l)&&d.add(p),p.querySelectorAll(l).forEach((n)=> {d.add(n)}))});else if(e.type===
"attributes"&&e.attributeName==="class"){var k=e.target;e.target.nodeType===Node.ELEMENT_NODE&&k.matches(l)&&d.add(k)}else e.type==="characterData"&&e.target.parentNode&&(e=e.target.parentNode,e.nodeType===Node.ELEMENT_NODE&&e.matches(l)&&d.add(e));d.size>0&&setTimeout(()=> {d.forEach((p)=> {c(p)})},500)})).observe(document.body,{childList:!0,subtree:!0,attributes:!0,attributeFilter:["class"],characterData:!0})})}).catch(function(a){console.error("IconChecker: Font loading error. Scanning icons anyway.",
...
const IMG_GEN_REPLACE_MAP = {"middle aged brazilian man wearing sunglasses and soccer jersey holding a bbq skewer smiling cartoon style": "https://lh3.googleusercontent.com/gg-dl/ABS2GSmFyHIo9-EknJEzQDLachANoIR4AhLdBIosofeDndcouYvyVn1LlwYU4cQcD_XPu0VvEV55rA0EnrIczMTM7_3xGBk4HXmNT77uesadKPsU1BNIuqV4TKD7v7qjhOasjpJXfLo3NqmnmI9URZX_FdcbBK2bgtjeaH-lD2rguTHf9fFPFQ", "man in business suit levitating in space with glowing geometry symbols around head cartoon style": "https://lh3.googleusercontent.com/gg-dl/ABS2GSkOz8OtYnLr4MaokEzJUFE_4Rv_AtSCwUvWU8OerZ03y_gZIUK58pyGS15pGGt5UQNHQ046JjOLXrHNYIiogwuDnexDmrIp4fWamU0cxOW5NAS_wxRoJBSF4xRoEzK65NXgkirwKUTJFkWvnRigjt4jIuIBEHwo2qkY3JRB9kMJgfdszw", "young adult rolling eyes and shrugging shoulders wearing casual hoodie cartoon style": "https://lh3.googleusercontent.com/gg-dl/ABS2GSnh96TA6pvctetaEdnoyvjabXE4b1D_kbu3u3_K_6yHRXQUv0-Q8yEfI8RS4cUd1mtFnPlC1KeUe4iq8x0GA-b4BrXPjNaLzGeKdVyQ3ZQxZCoUWAU60LdWf2CHXbOllCKSd-FMnX1HIl_E4n3t7CTRMUmchj6nemo6fYdb--xB4C7Ugw"};
...
b.prototype.Z=function(f){var g=this.D();f.ca(g.resolve,g.reject)};b.prototype.aa=function(f,g){var l=this.D();try{f.call(g,l.resolve,l.reject)}catch(m){l.reject(m)}};b.prototype.then=function(f,g){function l(F,I){return typeof F=="function"?((O)=> {try{m(F(O))}catch(X){u(X)}}):I}var m,u,D=new b(function(F,I){m=F;u=I});this.ca(l(f,m),l(g,u));return D};b.prototype.catch=function(f){return this.then(void 0,f)};b.prototype.ca=function(f,g){function l(){switch(m.B){case 1:f(m.C);break;case 2:g(m.C);
break;default:throw Error("Unexpected state: "+m.B);}}var m=this;this.A==null?k.B(l):this.A.push(l);this.H=!0};b.resolve=d;b.reject=function(f){return new b(function(g,l){l(f)})};b.race=function(f){return new b(function(g,l){for(var m=t(f),u=m.next();!u.done;u=m.next())d(u.value).ca(g,l)})};b.all=function(f){var g=t(f),l=g.next();return l.done?d([]):new b(function(m,u){function D(O){return (X)=> {F[O]=X;I--;I==0&&m(F)}}var F=[],I=0;do F.push(void 0),I++,d(l.value).ca(D(F.length-1),u),l=g.next();
...
q("String.prototype.includes",function(a){return a?a:function(b,c){return Ja(this,b,"includes").indexOf(b,c||0)!==-1}});q("Array.from",function(a){return a?a:function(b,c,d){c=c!=null?c:((g)=> g);var e=[],k=typeof Symbol!="undefined"&&Symbol.iterator&&b[Symbol.iterator];if(typeof k=="function"){b=k.call(b);for(var f=0;!(k=b.next()).done;)e.push(c.call(d,k.value,f++))}else for(k=b.length,f=0;f<k;f++)e.push(c.call(d,b[f],f));return e}});
...
xb++;y=Id(y);gf(n,y);A.A=0})}function hf(){(new MutationObserver((h,n)=> {var r,y,A;return w((B)=> {if(B.A==1){if(xb>1E4)return console.debug("Too many mutations, stopping mutation observer."),n.disconnect(),B.return();r=t(h);y=r.next()}if(B.A!=3){if(y.done){B.A=0;return}A=y.value;if(A.type==="childList"&&A.addedNodes.length>0){A.addedNodes.forEach((P)=> {var L;return w((J)=> {if(J.A==1){if(P.nodeType!==Node.ELEMENT_NODE){J.A=0;return}L=P;MAY_HAVE_BACKGROUND_IMAGE?J=v(J,yb(L),
3):(J.A=3,J=void 0);return J}if(L.tagName!=="IMG")L.querySelectorAll&&(MAY_HAVE_BACKGROUND_IMAGE&&L.querySelectorAll("*").forEach((H)=> w((C)=> v(C,yb(H),0))),L.querySelectorAll("img").forEach((H)=> w((C)=> v(C,bb(H),0)))),J.A=0;else return v(J,bb(P),0)})});B.A=3;return}A.type==="attributes"&&A.attributeName==="src"?A.target.nodeType!==Node.ELEMENT_NODE||A.target.tagName!=="IMG"?(B.A=3,B=void 0):B=v(B,bb(A.target,!0),3):MAY_HAVE_BACKGROUND_IMAGE&&
...
<!-- SEO & Meta Info -->
<title>Te Ajudo, Mas Não Muito - Conselhos Questionáveis</title>
<meta content="Um app que te zoa de leve e te dá conselhos questionáveis. Tio do Churrasco, Coach Quântico e Amigo Sincero." name="description">
<!-- Tech Stack: Tailwind CSS 4 (via CDN for portability) -->
...
<style>*, ::before, ::after{--tw-border-spacing-x:0;--tw-border-spacing-y:0;--tw-translate-x:0;--tw-translate-y:0;--tw-rotate:0;--tw-skew-x:0;--tw-skew-y:0;--tw-scale-x:1;--tw-scale-y:1;--tw-pan-x: ;--tw-pan-y: ;--tw-pinch-zoom: ;--tw-scroll-snap-strictness:proximity;--tw-gradient-from-position: ;--tw-gradient-via-position: ;--tw-gradient-to-position: ;--tw-ordinal: ;--tw-slashed-zero: ;--tw-numeric-figure: ;--tw-numeric-spacing: ;--tw-numeric-fraction: ;--tw-ring-inset: ;--tw-ring-offset-width:0px;--tw-ring-offset-color:#fff;--tw-ring-color:rgb(59 130 246 / 0.5);--tw-ring-offset-shadow:0 0 #0000;--tw-ring-shadow:0 0 #0000;--tw-shadow:0 0 #0000;--tw-shadow-colored:0 0 #0000;--tw-blur: ;--tw-brightness: ;--tw-contrast: ;--tw-grayscale: ;--tw-hue-rotate: ;--tw-invert: ;--tw-saturate: ;--tw-sepia: ;--tw-drop-shadow: ;--tw-backdrop-blur: ;--tw-backdrop-brightness: ;--tw-backdrop-contrast: ;--tw-backdrop-grayscale: ;--tw-backdrop-hue-rotate: ;--tw-backdrop-invert: ;--tw-backdrop-opacity: ;--tw-backdrop-saturate: ;--tw-backdrop-sepia: ;--tw-contain-size: ;--tw-contain-layout: ;--tw-contain-paint: ;--tw-contain-style: }::backdrop{--tw-border-spacing-x:0;--tw-border-spacing-y:0;--tw-translate-x:0;--tw-translate-y:0;--tw-rotate:0;--tw-skew-x:0;--tw-skew-y:0;--tw-scale-x:1;--tw-scale-y:1;--tw-pan-x: ;--tw-pan-y: ;--tw-pinch-zoom: ;--tw-scroll-snap-strictness:proximity;--tw-gradient-from-position: ;--tw-gradient-via-position: ;--tw-gradient-to-position: ;--tw-ordinal: ;--tw-slashed-zero: ;--tw-numeric-figure: ;--tw-numeric-spacing: ;--tw-numeric-fraction: ;--tw-ring-inset: ;--tw-ring-offset-width:0px;--tw-ring-offset-color:#fff;--tw-ring-color:rgb(59 130 246 / 0.5);--tw-ring-offset-shadow:0 0 #0000;--tw-ring-shadow:0 0 #0000;--tw-shadow:0 0 #0000;--tw-shadow-colored:0 0 #0000;--tw-blur: ;--tw-brightness: ;--tw-contrast: ;--tw-grayscale: ;--tw-hue-rotate: ;--tw-invert: ;--tw-saturate: ;--tw-sepia: ;--tw-drop-shadow: ;--tw-backdrop-blur: ;--tw-backdrop-brightness: ;--tw-backdrop-contrast: ;--tw-backdrop-grayscale: ;--tw-backdrop-hue-rotate: ;--tw-backdrop-invert: ;--tw-backdrop-opacity: ;--tw-backdrop-saturate: ;--tw-backdrop-sepia: ;--tw-contain-size: ;--tw-contain-layout: ;--tw-contain-paint: ;--tw-contain-style: }/* ! tailwindcss v3.4.17 | MIT License | https://tailwindcss.com */*,::after,::before{box-sizing:border-box;border-width:0;border-style:solid;border-color:#e5e7eb}::after,::before{--tw-content:''}:host,html{line-height:1.5;-webkit-text-size-adjust:100%;-moz-tab-size:4;tab-size:4;font-family:ui-sans-serif, system-ui, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji";font-feature-settings:normal;font-variation-settings:normal;-webkit-tap-highlight-color:transparent}body{margin:0;line-height:inherit}hr{height:0;color:inherit;border-top-width:1px}abbr:where([title]){-webkit-text-decoration:underline dotted;text-decoration:underline dotted}h1,h2,h3,h4,h5,h6{font-size:inherit;font-weight:inherit}a{color:inherit;text-decoration:inherit}b,strong{font-weight:bolder}code,kbd,pre,samp{font-family:ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, "Liberation Mono", "Courier New", monospace;font-feature-settings:normal;font-variation-settings:normal;font-size:1em}small{font-size:80%}sub,sup{font-size:75%;line-height:0;position:relative;vertical-align:baseline}sub{bottom:-.25em}sup{top:-.5em}table{text-indent:0;border-color:inherit;border-collapse:collapse}button,input,optgroup,select,textarea{font-family:inherit;font-feature-settings:inherit;font-variation-settings:inherit;font-size:100%;font-weight:inherit;line-height:inherit;letter-spacing:inherit;color:inherit;margin:0;padding:0}button,select{text-transform:none}button,input:where([type=button]),input:where([type=reset]),input:where([type=submit]){-webkit-appearance:button;background-color:transparent;background-image:none}:-moz-focusring{outline:auto}:-moz-ui-invalid{box-shadow:none}progress{vertical-align:baseline}::-webkit-inner-spin-button,::-webkit-outer-spin-button{height:auto}[type=search]{-webkit-appearance:textfield;outline-offset:-2px}::-webkit-search-decoration{-webkit-appearance:none}::-webkit-file-upload-button{-webkit-appearance:button;font:inherit}summary{display:list-item}blockquote,dd,dl,figure,h1,h2,h3,h4,h5,h6,hr,p,pre{margin:0}fieldset{margin:0;padding:0}legend{padding:0}menu,ol,ul{list-style:none;margin:0;padding:0}dialog{padding:0}textarea{resize:vertical}input::placeholder,textarea::placeholder{opacity:1;color:#9ca3af}[role=button],button{cursor:pointer}:disabled{cursor:default}audio,canvas,embed,iframe,img,object,svg,video{display:block;vertical-align:middle}img,video{max-width:100%;height:auto}[hidden]:where(:not([hidden=until-found])){display:none}.container{width:100%}@media (min-width: 640px){.container{max-width:640px}}@media (min-width: 768px){.container{max-width:768px}}@media (min-width: 1024px){.container{max-width:1024px}}@media (min-width: 1280px){.container{max-width:1280px}}@media (min-width: 1536px){.container{max-width:1536px}}.sr-only{position:absolute;width:1px;height:1px;padding:0;margin:-1px;overflow:hidden;clip:rect(0, 0, 0, 0);white-space:nowrap;border-width:0}.pointer-events-none{pointer-events:none}.absolute{position:absolute}.relative{position:relative}.sticky{position:sticky}.inset-0{inset:0px}.bottom-0{bottom:0px}.left-0{left:0px}.right-0{right:0px}.right-4{right:1rem}.top-0{top:0px}.top-4{top:1rem}.-z-0{z-index:0}.z-0{z-index:0}.z-10{z-index:10}.z-50{z-index:50}.mx-auto{margin-left:auto;margin-right:auto}.mb-12{margin-bottom:3rem}.mb-16{margin-bottom:4rem}.mb-2{margin-bottom:0.5rem}.mb-3{margin-bottom:0.75rem}.mb-4{margin-bottom:1rem}.mb-6{margin-bottom:1.5rem}.mb-8{margin-bottom:2rem}.mt-1{margin-top:0.25rem}.mt-2{margin-top:0.5rem}.mt-4{margin-top:1rem}.mt-8{margin-top:2rem}.block{display:block}.inline-block{display:inline-block}.flex{display:flex}.inline-flex{display:inline-flex}.grid{display:grid}.hidden{display:none}.h-12{height:3rem}.h-16{height:4rem}.h-2{height:0.5rem}.h-3{height:0.75rem}.h-96{height:24rem}.h-full{height:100%}.min-h-screen{min-height:100vh}.w-12{width:3rem}.w-16{width:4rem}.w-2{width:0.5rem}.w-3{width:0.75rem}.w-96{width:24rem}.w-full{width:100%}.max-w-2xl{max-width:42rem}.max-w-3xl{max-width:48rem}.max-w-4xl{max-width:56rem}.max-w-5xl{max-width:64rem}.max-w-xl{max-width:36rem}.flex-1{flex:1 1 0%}.flex-grow{flex-grow:1}.-translate-x-1\/2{--tw-translate-x:-50%;transform:translate(var(--tw-translate-x), var(--tw-translate-y)) rotate(var(--tw-rotate)) skewX(var(--tw-skew-x)) skewY(var(--tw-skew-y)) scaleX(var(--tw-scale-x)) scaleY(var(--tw-scale-y))}.-translate-y-1\/2{--tw-translate-y:-50%;transform:translate(var(--tw-translate-x), var(--tw-translate-y)) rotate(var(--tw-rotate)) skewX(var(--tw-skew-x)) skewY(var(--tw-skew-y)) scaleX(var(--tw-scale-x)) scaleY(var(--tw-scale-y))}.translate-x-1\/2{--tw-translate-x:50%;transform:translate(var(--tw-translate-x), var(--tw-translate-y)) rotate(var(--tw-rotate)) skewX(var(--tw-skew-x)) skewY(var(--tw-skew-y)) scaleX(var(--tw-scale-x)) scaleY(var(--tw-scale-y))}.translate-y-1\/2{--tw-translate-y:50%;transform:translate(var(--tw-translate-x), var(--tw-translate-y)) rotate(var(--tw-rotate)) skewX(var(--tw-skew-x)) skewY(var(--tw-skew-y)) scaleX(var(--tw-scale-x)) scaleY(var(--tw-scale-y))}.transform{transform:translate(var(--tw-translate-x), var(--tw-translate-y)) rotate(var(--tw-rotate)) skewX(var(--tw-skew-x)) skewY(var(--tw-skew-y)) scaleX(var(--tw-scale-x)) scaleY(var(--tw-scale-y))}@keyframes ping{75%, 100%{transform:scale(2);opacity:0}}.animate-ping{animation:ping 1s cubic-bezier(0, 0, 0.2, 1) infinite}@keyframes pulse{50%{opacity:.5}}.animate-pulse{animation:pulse 2s cubic-bezier(0.4, 0, 0.6, 1) infinite}@keyframes spin{to{transform:rotate(360deg)}}.animate-spin{animation:spin 1s linear infinite}.cursor-pointer{cursor:pointer}.select-none{-webkit-user-select:none;user-select:none}.resize-none{resize:none}.grid-cols-1{grid-template-columns:repeat(1, minmax(0, 1fr))}.flex-col{flex-direction:column}.flex-wrap{flex-wrap:wrap}.items-center{align-items:center}.justify-end{justify-content:flex-end}.justify-center{justify-content:center}.justify-between{justify-content:space-between}.gap-1{gap:0.25rem}.gap-1\.5{gap:0.375rem}.gap-12{gap:3rem}.gap-2{gap:0.5rem}.gap-3{gap:0.75rem}.gap-4{gap:1rem}.gap-6{gap:1.5rem}.gap-8{gap:2rem}.space-y-2 > :not([hidden]) ~ :not([hidden]){--tw-space-y-reverse:0;margin-top:calc(0.5rem * calc(1 - var(--tw-space-y-reverse)));margin-bottom:calc(0.5rem * var(--tw-space-y-reverse))}.space-y-6 > :not([hidden]) ~ :not([hidden]){--tw-space-y-reverse:0;margin-top:calc(1.5rem * calc(1 - var(--tw-space-y-reverse)));margin-bottom:calc(1.5rem * var(--tw-space-y-reverse))}.overflow-hidden{overflow:hidden}.scroll-smooth{scroll-behavior:smooth}.rounded-2xl{border-radius:1rem}.rounded-full{border-radius:9999px}.rounded-lg{border-radius:0.5rem}.rounded-xl{border-radius:0.75rem}.border{border-width:1px}.border-2{border-width:2px}.border-4{border-width:4px}.border-y{border-top-width:1px;border-bottom-width:1px}.border-b{border-bottom-width:1px}.border-t{border-top-width:1px}.border-indigo-100{--tw-border-opacity:1;border-color:rgb(224 231 255 / var(--tw-border-opacity, 1))}.border-slate-100{--tw-border-opacity:1;border-color:rgb(241 245 249 / var(--tw-border-opacity, 1))}.border-slate-200{--tw-border-opacity:1;border-color:rgb(226 232 240 / var(--tw-border-opacity, 1))}.border-slate-300{--tw-border-opacity:1;border-color:rgb(203 213 225 / var(--tw-border-opacity, 1))}.border-slate-700{--tw-border-opacity:1;border-color:rgb(51 65 85 / var(--tw-border-opacity, 1))}.border-slate-900{--tw-border-opacity:1;border-color:rgb(15 23 42 / var(--tw-border-opacity, 1))}.border-t-indigo-600{--tw-border-opacity:1;border-top-color:rgb(79 70 229 / var(--tw-border-opacity, 1))}.bg-green-400{--tw-bg-opacity:1;background-color:rgb(74 222 128 / var(--tw-bg-opacity, 1))}.bg-green-500{--tw-bg-opacity:1;background-color:rgb(34 197 94 / var(--tw-bg-opacity, 1))}.bg-indigo-400{--tw-bg-opacity:1;background-color:rgb(129 140 248 / var(--tw-bg-opacity, 1))}.bg-indigo-50{--tw-bg-opacity:1;background-color:rgb(238 242 255 / var(--tw-bg-opacity, 1))}.bg-indigo-500{--tw-bg-opacity:1;background-color:rgb(99 102 241 / var(--tw-bg-opacity, 1))}.bg-indigo-600{--tw-bg-opacity:1;background-color:rgb(79 70 229 / var(--tw-bg-opacity, 1))}.bg-orange-100{--tw-bg-opacity:1;background-color:rgb(255 237 213 / var(--tw-bg-opacity, 1))}.bg-orange-200{--tw-bg-opacity:1;background-color:rgb(254 215 170 / var(--tw-bg-opacity, 1))}.bg-purple-100{--tw-bg-opacity:1;background-color:rgb(243 232 255 / var(--tw-bg-opacity, 1))}.bg-purple-200{--tw-bg-opacity:1;background-color:rgb(233 213 255 / var(--tw-bg-opacity, 1))}.bg-red-400{--tw-bg-opacity:1;background-color:rgb(248 113 113 / var(--tw-bg-opacity, 1))}.bg-red-500{--tw-bg-opacity:1;background-color:rgb(239 68 68 / var(--tw-bg-opacity, 1))}.bg-slate-50{--tw-bg-opacity:1;background-color:rgb(248 250 252 / var(--tw-bg-opacity, 1))}.bg-slate-800{--tw-bg-opacity:1;background-color:rgb(30 41 59 / var(--tw-bg-opacity, 1))}.bg-slate-900{--tw-bg-opacity:1;background-color:rgb(15 23 42 / var(--tw-bg-opacity, 1))}.bg-slate-950{--tw-bg-opacity:1;background-color:rgb(2 6 23 / var(--tw-bg-opacity, 1))}.bg-teal-100{--tw-bg-opacity:1;background-color:rgb(204 251 241 / var(--tw-bg-opacity, 1))}.bg-white{--tw-bg-opacity:1;background-color:rgb(255 255 255 / var(--tw-bg-opacity, 1))}.bg-white\/80{background-color:rgb(255 255 255 / 0.8)}.bg-yellow-400{--tw-bg-opacity:1;background-color:rgb(250 204 21 / var(--tw-bg-opacity, 1))}.bg-yellow-500{--tw-bg-opacity:1;background-color:rgb(234 179 8 / var(--tw-bg-opacity, 1))}.bg-gradient-to-r{background-image:linear-gradient(to right, var(--tw-gradient-stops))}.from-indigo-600{--tw-gradient-from:#4f46e5 var(--tw-gradient-from-position);--tw-gradient-to:rgb(79 70 229 / 0) var(--tw-gradient-to-position);--tw-gradient-stops:var(--tw-gradient-from), var(--tw-gradient-to)}.to-purple-600{--tw-gradient-to:#9333ea var(--tw-gradient-to-position)}.bg-clip-text{-webkit-background-clip:text;background-clip:text}.object-cover{object-fit:cover}.p-2{padding:0.5rem}.p-4{padding:1rem}.p-6{padding:1.5rem}.px-3{padding-left:0.75rem;padding-right:0.75rem}.px-4{padding-left:1rem;padding-right:1rem}.px-6{padding-left:1.5rem;padding-right:1.5rem}.py-1{padding-top:0.25rem;padding-bottom:0.25rem}.py-12{padding-top:3rem;padding-bottom:3rem}.py-16{padding-top:4rem;padding-bottom:4rem}.py-20{padding-top:5rem;padding-bottom:5rem}.py-3{padding-top:0.75rem;padding-bottom:0.75rem}.py-4{padding-top:1rem;padding-bottom:1rem}.py-8{padding-top:2rem;padding-bottom:2rem}.pb-32{padding-bottom:8rem}.pl-4{padding-left:1rem}.pt-20{padding-top:5rem}.text-center{text-align:center}.font-mono{font-family:ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, "Liberation Mono", "Courier New", monospace}.text-2xl{font-size:1.5rem;line-height:2rem}.text-3xl{font-size:1.875rem;line-height:2.25rem}.text-5xl{font-size:3rem;line-height:1}.text-6xl{font-size:3.75rem;line-height:1}.text-base{font-size:1rem;line-height:1.5rem}.text-lg{font-size:1.125rem;line-height:1.75rem}.text-sm{font-size:0.875rem;line-height:1.25rem}.text-xl{font-size:1.25rem;line-height:1.75rem}.text-xs{font-size:0.75rem;line-height:1rem}.font-bold{font-weight:700}.font-medium{font-weight:500}.font-normal{font-weight:400}.font-semibold{font-weight:600}.uppercase{text-transform:uppercase}.italic{font-style:italic}.leading-relaxed{line-height:1.625}.leading-snug{line-height:1.375}.leading-tight{line-height:1.25}.tracking-tight{letter-spacing:-0.025em}.tracking-wider{letter-spacing:0.05em}.text-blue-400{--tw-text-opacity:1;color:rgb(96 165 250 / var(--tw-text-opacity, 1))}.text-cyan-400{--tw-text-opacity:1;color:rgb(34 211 238 / var(--tw-text-opacity, 1))}.text-green-400{--tw-text-opacity:1;color:rgb(74 222 128 / var(--tw-text-opacity, 1))}.text-green-500{--tw-text-opacity:1;color:rgb(34 197 94 / var(--tw-text-opacity, 1))}.text-indigo-600{--tw-text-opacity:1;color:rgb(79 70 229 / var(--tw-text-opacity, 1))}.text-indigo-700{--tw-text-opacity:1;color:rgb(67 56 202 / var(--tw-text-opacity, 1))}.text-orange-400{--tw-text-opacity:1;color:rgb(251 146 60 / var(--tw-text-opacity, 1))}.text-orange-600{--tw-text-opacity:1;color:rgb(234 88 12 / var(--tw-text-opacity, 1))}.text-purple-400{--tw-text-opacity:1;color:rgb(192 132 252 / var(--tw-text-opacity, 1))}.text-purple-600{--tw-text-opacity:1;color:rgb(147 51 234 / var(--tw-text-opacity, 1))}.text-red-600{--tw-text-opacity:1;color:rgb(220 38 38 / var(--tw-text-opacity, 1))}.text-sky-400{--tw-text-opacity:1;color:rgb(56 189 248 / var(--tw-text-opacity, 1))}.text-slate-200{--tw-text-opacity:1;color:rgb(226 232 240 / var(--tw-text-opacity, 1))}.text-slate-300{--tw-text-opacity:1;color:rgb(203 213 225 / var(--tw-text-opacity, 1))}.text-slate-400{--tw-text-opacity:1;color:rgb(148 163 184 / var(--tw-text-opacity, 1))}.text-slate-500{--tw-text-opacity:1;color:rgb(100 116 139 / var(--tw-text-opacity, 1))}.text-slate-600{--tw-text-opacity:1;color:rgb(71 85 105 / var(--tw-text-opacity, 1))}.text-slate-700{--tw-text-opacity:1;color:rgb(51 65 85 / var(--tw-text-opacity, 1))}.text-slate-800{--tw-text-opacity:1;color:rgb(30 41 59 / var(--tw-text-opacity, 1))}.text-slate-900{--tw-text-opacity:1;color:rgb(15 23 42 / var(--tw-text-opacity, 1))}.text-teal-600{--tw-text-opacity:1;color:rgb(13 148 136 / var(--tw-text-opacity, 1))}.text-transparent{color:transparent}.text-white{--tw-text-opacity:1;color:rgb(255 255 255 / var(--tw-text-opacity, 1))}.text-yellow-300{--tw-text-opacity:1;color:rgb(253 224 71 / var(--tw-text-opacity, 1))}.opacity-30{opacity:0.3}.opacity-70{opacity:0.7}.opacity-75{opacity:0.75}.shadow-2xl{--tw-shadow:0 25px 50px -12px rgb(0 0 0 / 0.25);--tw-shadow-colored:0 25px 50px -12px var(--tw-shadow-color);box-shadow:var(--tw-ring-offset-shadow, 0 0 #0000), var(--tw-ring-shadow, 0 0 #0000), var(--tw-shadow)}.shadow-lg{--tw-shadow:0 10px 15px -3px rgb(0 0 0 / 0.1), 0 4px 6px -4px rgb(0 0 0 / 0.1);--tw-shadow-colored:0 10px 15px -3px var(--tw-shadow-color), 0 4px 6px -4px var(--tw-shadow-color);box-shadow:var(--tw-ring-offset-shadow, 0 0 #0000), var(--tw-ring-shadow, 0 0 #0000), var(--tw-shadow)}.shadow-xl{--tw-shadow:0 20px 25px -5px rgb(0 0 0 / 0.1), 0 8px 10px -6px rgb(0 0 0 / 0.1);--tw-shadow-colored:0 20px 25px -5px var(--tw-shadow-color), 0 8px 10px -6px var(--tw-shadow-color);box-shadow:var(--tw-ring-offset-shadow, 0 0 #0000), var(--tw-ring-shadow, 0 0 #0000), var(--tw-shadow)}.shadow-indigo-200{--tw-shadow-color:#c7d2fe;--tw-shadow:var(--tw-shadow-colored)}.ring-2{--tw-ring-offset-shadow:var(--tw-ring-inset) 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color);--tw-ring-shadow:var(--tw-ring-inset) 0 0 0 calc(2px + var(--tw-ring-offset-width)) var(--tw-ring-color);box-shadow:var(--tw-ring-offset-shadow), var(--tw-ring-shadow), var(--tw-shadow, 0 0 #0000)}.ring-transparent{--tw-ring-color:transparent}.ring-offset-2{--tw-ring-offset-width:2px}.blur-3xl{--tw-blur:blur(64px);filter:var(--tw-blur) var(--tw-brightness) var(--tw-contrast) var(--tw-grayscale) var(--tw-hue-rotate) var(--tw-invert) var(--tw-saturate) var(--tw-sepia) var(--tw-drop-shadow)}.grayscale{--tw-grayscale:grayscale(100%);filter:var(--tw-blur) var(--tw-brightness) var(--tw-contrast) var(--tw-grayscale) var(--tw-hue-rotate) var(--tw-invert) var(--tw-saturate) var(--tw-sepia) var(--tw-drop-shadow)}.backdrop-blur-md{--tw-backdrop-blur:blur(12px);-webkit-backdrop-filter:var(--tw-backdrop-blur) var(--tw-backdrop-brightness) var(--tw-backdrop-contrast) var(--tw-backdrop-grayscale) var(--tw-backdrop-hue-rotate) var(--tw-backdrop-invert) var(--tw-backdrop-opacity) var(--tw-backdrop-saturate) var(--tw-backdrop-sepia);backdrop-filter:var(--tw-backdrop-blur) var(--tw-backdrop-brightness) var(--tw-backdrop-contrast) var(--tw-backdrop-grayscale) var(--tw-backdrop-hue-rotate) var(--tw-backdrop-invert) var(--tw-backdrop-opacity) var(--tw-backdrop-saturate) var(--tw-backdrop-sepia)}.transition-all{transition-property:all;transition-timing-function:cubic-bezier(0.4, 0, 0.2, 1);transition-duration:150ms}.transition-colors{transition-property:color, background-color, border-color, fill, stroke, -webkit-text-decoration-color;transition-property:color, background-color, border-color, text-decoration-color, fill, stroke;transition-property:color, background-color, border-color, text-decoration-color, fill, stroke, -webkit-text-decoration-color;transition-timing-function:cubic-bezier(0.4, 0, 0.2, 1);transition-duration:150ms}.transition-transform{transition-property:transform;transition-timing-function:cubic-bezier(0.4, 0, 0.2, 1);transition-duration:150ms}.duration-300{transition-duration:300ms}.placeholder\:text-slate-400::placeholder{--tw-text-opacity:1;color:rgb(148 163 184 / var(--tw-text-opacity, 1))}.hover\:border-orange-200:hover{--tw-border-opacity:1;border-color:rgb(254 215 170 / var(--tw-border-opacity, 1))}.hover\:border-purple-200:hover{--tw-border-opacity:1;border-color:rgb(233 213 255 / var(--tw-border-opacity, 1))}.hover\:border-teal-200:hover{--tw-border-opacity:1;border-color:rgb(153 246 228 / var(--tw-border-opacity, 1))}.hover\:bg-indigo-700:hover{--tw-bg-opacity:1;background-color:rgb(67 56 202 / var(--tw-bg-opacity, 1))}.hover\:bg-slate-50:hover{--tw-bg-opacity:1;background-color:rgb(248 250 252 / var(--tw-bg-opacity, 1))}.hover\:bg-slate-800:hover{--tw-bg-opacity:1;background-color:rgb(30 41 59 / var(--tw-bg-opacity, 1))}.hover\:text-black:hover{--tw-text-opacity:1;color:rgb(0 0 0 / var(--tw-text-opacity, 1))}.hover\:text-indigo-600:hover{--tw-text-opacity:1;color:rgb(79 70 229 / var(--tw-text-opacity, 1))}.hover\:text-indigo-800:hover{--tw-text-opacity:1;color:rgb(55 48 163 / var(--tw-text-opacity, 1))}.hover\:text-white:hover{--tw-text-opacity:1;color:rgb(255 255 255 / var(--tw-text-opacity, 1))}.hover\:shadow-xl:hover{--tw-shadow:0 20px 25px -5px rgb(0 0 0 / 0.1), 0 8px 10px -6px rgb(0 0 0 / 0.1);--tw-shadow-colored:0 20px 25px -5px var(--tw-shadow-color), 0 8px 10px -6px var(--tw-shadow-color);box-shadow:var(--tw-ring-offset-shadow, 0 0 #0000), var(--tw-ring-shadow, 0 0 #0000), var(--tw-shadow)}.hover\:shadow-orange-100\/50:hover{--tw-shadow-color:rgb(255 237 213 / 0.5);--tw-shadow:var(--tw-shadow-colored)}.hover\:shadow-purple-100\/50:hover{--tw-shadow-color:rgb(243 232 255 / 0.5);--tw-shadow:var(--tw-shadow-colored)}.hover\:shadow-teal-100\/50:hover{--tw-shadow-color:rgb(204 251 241 / 0.5);--tw-shadow:var(--tw-shadow-colored)}.focus\:border-indigo-500:focus{--tw-border-opacity:1;border-color:rgb(99 102 241 / var(--tw-border-opacity, 1))}.focus\:ring-2:focus{--tw-ring-offset-shadow:var(--tw-ring-inset) 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color);--tw-ring-shadow:var(--tw-ring-inset) 0 0 0 calc(2px + var(--tw-ring-offset-width)) var(--tw-ring-color);box-shadow:var(--tw-ring-offset-shadow), var(--tw-ring-shadow), var(--tw-shadow, 0 0 #0000)}.focus\:ring-indigo-500:focus{--tw-ring-opacity:1;--tw-ring-color:rgb(99 102 241 / var(--tw-ring-opacity, 1))}.active\:scale-\[0\.98\]:active{--tw-scale-x:0.98;--tw-scale-y:0.98;transform:translate(var(--tw-translate-x), var(--tw-translate-y)) rotate(var(--tw-rotate)) skewX(var(--tw-skew-x)) skewY(var(--tw-skew-y)) scaleX(var(--tw-scale-x)) scaleY(var(--tw-scale-y))}.group:hover .group-hover\:scale-105{--tw-scale-x:1.05;--tw-scale-y:1.05;transform:translate(var(--tw-translate-x), var(--tw-translate-y)) rotate(var(--tw-rotate)) skewX(var(--tw-skew-x)) skewY(var(--tw-skew-y)) scaleX(var(--tw-scale-x)) scaleY(var(--tw-scale-y))}.group:hover .group-hover\:scale-110{--tw-scale-x:1.1;--tw-scale-y:1.1;transform:translate(var(--tw-translate-x), var(--tw-translate-y)) rotate(var(--tw-rotate)) skewX(var(--tw-skew-x)) skewY(var(--tw-skew-y)) scaleX(var(--tw-scale-x)) scaleY(var(--tw-scale-y))}.peer:checked ~ .peer-checked\:border-orange-500{--tw-border-opacity:1;border-color:rgb(249 115 22 / var(--tw-border-opacity, 1))}.peer:checked ~ .peer-checked\:border-purple-500{--tw-border-opacity:1;border-color:rgb(168 85 247 / var(--tw-border-opacity, 1))}.peer:checked ~ .peer-checked\:border-teal-500{--tw-border-opacity:1;border-color:rgb(20 184 166 / var(--tw-border-opacity, 1))}.peer:checked ~ .peer-checked\:bg-orange-50{--tw-bg-opacity:1;background-color:rgb(255 247 237 / var(--tw-bg-opacity, 1))}.peer:checked ~ .peer-checked\:bg-purple-50{--tw-bg-opacity:1;background-color:rgb(250 245 255 / var(--tw-bg-opacity, 1))}.peer:checked ~ .peer-checked\:bg-teal-50{--tw-bg-opacity:1;background-color:rgb(240 253 250 / var(--tw-bg-opacity, 1))}.peer:checked ~ .peer-checked\:ring-orange-500{--tw-ring-opacity:1;--tw-ring-color:rgb(249 115 22 / var(--tw-ring-opacity, 1))}.peer:checked ~ .peer-checked\:ring-purple-500{--tw-ring-opacity:1;--tw-ring-color:rgb(168 85 247 / var(--tw-ring-opacity, 1))}.peer:checked ~ .peer-checked\:ring-teal-500{--tw-ring-opacity:1;--tw-ring-color:rgb(20 184 166 / var(--tw-ring-opacity, 1))}@media (min-width: 768px){.md\:flex{display:flex}.md\:hidden{display:none}.md\:grid-cols-2{grid-template-columns:repeat(2, minmax(0, 1fr))}.md\:grid-cols-3{grid-template-columns:repeat(3, minmax(0, 1fr))}.md\:p-8{padding:2rem}.md\:text-4xl{font-size:2.25rem;line-height:2.5rem}.md\:text-7xl{font-size:4.5rem;line-height:1}}</style><link type="text/css" href="https://fonts.googleapis.com/css2?family=Google+Symbols:opsz,wght,FILL,GRAD,ROND@24,400,0,0,50&amp;icon_names=link" rel="stylesheet"><style id="dyn-img-link-styles-di-script">
      .dyn-img-link-wrapper-di-script {
        anchor-scope: all;
        display: contents;
        position: relative;
...
<span class="material-symbols-outlined text-indigo-600 text-3xl">sentiment_very_dissatisfied</span>
<span class="text-xl font-bold tracking-tight brand-font">Te Ajudo<span class="text-slate-400 font-normal">, Mas Não Muito</span></span>
</div>
<nav class="hidden md:flex gap-6 items-center text-sm font-medium text-slate-600">
<a class="hover:text-indigo-600 transition-colors" href="#como-funciona">Como Funciona</a>
<a class="hover:text-indigo-600 transition-colors" href="#modos">Modos</a>
<a class="hover:text-indigo-600 transition-colors" href="#tech">Arquitetura</a>
<a class="flex items-center gap-1 hover:text-black transition-colors" href="https://github.com" target="_blank" rel="noopener">
                    GitHub <span class="material-symbols-outlined text-sm">open_in_new</span>
</a>
</nav>
...
<div class="absolute top-0 right-0 w-96 h-96 bg-purple-200 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2"></div>
<div class="absolute bottom-0 left-0 w-96 h-96 bg-orange-200 rounded-full blur-3xl translate-y-1/2 -translate-x-1/2"></div>
</div>
<div class="container mx-auto max-w-4xl relative z-10 text-center mb-12">
<div class="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-indigo-50 text-indigo-700 text-sm font-medium mb-6 animate-fade-in border border-indigo-100">
...
<h1 class="text-5xl md:text-7xl font-bold leading-tight tracking-tight mb-6 brand-font animate-slide-up" style="animation-delay: 0.1s;">
                    Conselhos que você não pediu, mas <span class="text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 to-purple-600">precisava ouvir</span>.
                </h1>
<p class="text-xl text-slate-600 max-w-2xl mx-auto mb-8 leading-relaxed animate-slide-up" style="animation-delay: 0.2s;">
                    Um app divertido que mistura roasts leves com conselhos claramente questionáveis.
                    Escolha seu mentor e prepare-se para ouvir verdades inconvenientes.
                </p>
</div>
<!-- Interactive App Widget -->
<div class="container mx-auto max-w-3xl relative z-10 animate-slide-up" style="animation-delay: 0.3s;">
...
<div class="text-xs font-mono text-slate-400">v2.0.26-beta</div>
</div>
<div class="p-6 md:p-8">
<!-- VIEW 1: Input -->
<div class="space-y-6" id="input-section">
<!-- Text Input -->
<div>
<label class="block text-sm font-semibold text-slate-700 mb-2" for="situation">Qual é o seu drama de hoje?</label>
<textarea class="w-full px-4 py-3 rounded-lg border border-slate-300 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all resize-none text-slate-700 placeholder:text-slate-400" id="situation" placeholder="Ex: Meu chefe quer que eu trabalhe no fim de semana..." rows="3"></textarea>
<div class="mt-2 flex justify-end">
<button class="text-xs text-indigo-600 hover:text-indigo-800 font-medium flex items-center gap-1" onclick="fillRandom()">
<span class="material-symbols-outlined text-sm">shuffle</span> Estou sem criatividade
                                    </button>
</div>
</div>
<!-- Mode Selector -->
<div>
<label class="block text-sm font-semibold text-slate-700 mb-4">Quem vai te julgar?</label>
<div class="grid grid-cols-1 md:grid-cols-3 gap-4">
<!-- Card 1: Tio do Churrasco -->
<label class="relative cursor-pointer group">
<input class="peer sr-only" name="mode" onchange="selectMode('tio')" type="radio" value="tio">
<div class="p-4 rounded-xl border-2 border-slate-200 peer-checked:border-orange-500 peer-checked:bg-orange-50 hover:bg-slate-50 transition-all h-full flex flex-col items-center text-center">
<div class="w-16 h-16 rounded-full overflow-hidden mb-3 ring-2 ring-offset-2 ring-transparent peer-checked:ring-orange-500 group-hover:scale-105 transition-transform">
<img alt="Tio do Churrasco" class="w-full h-full object-cover" go-data-src="/gen?prompt=middle+aged+brazilian+man+wearing+sunglasses+and+soccer+jersey+holding+a+bbq+skewer+smiling+cartoon+style&amp;aspect=1:1" src="blob:https://32v45e0920krbtm24xzwvf5h0mz2ml76zyfcwifhf7ofwv16ny-h845251650.scf.usercontent.goog/7abe43dd-c1f6-454e-bc70-b02e203b8b4a" style="">
</div>
<div class="font-bold text-slate-800">Tio do Churrasco</div>
<div class="text-xs text-slate-500 mt-1">Simplicidade &amp; Sal Grosso</div>
</div>
</label>
<!-- Card 2: Coach Quântico -->
<label class="relative cursor-pointer group">
<input checked="" class="peer sr-only" name="mode" onchange="selectMode('coach')" type="radio" value="coach">
<div class="p-4 rounded-xl border-2 border-slate-200 peer-checked:border-purple-500 peer-checked:bg-purple-50 hover:bg-slate-50 transition-all h-full flex flex-col items-center text-center">
<div class="w-16 h-16 rounded-full overflow-hidden mb-3 ring-2 ring-offset-2 ring-transparent peer-checked:ring-purple-500 group-hover:scale-105 transition-transform">
<img alt="Coach Quântico" class="w-full h-full object-cover" go-data-src="/gen?prompt=man+in+business+suit+levitating+in+space+with+glowing+geometry+symbols+around+head+cartoon+style&amp;aspect=1:1" src="blob:https://32v45e0920krbtm24xzwvf5h0mz2ml76zyfcwifhf7ofwv16ny-h845251650.scf.usercontent.goog/c7289b77-3809-497d-a91b-ad0390706cd0" style="">
</div>
<div class="font-bold text-slate-800">Coach Quântico</div>
<div class="text-xs text-slate-500 mt-1">Mindset &amp; Vibração</div>
</div>
</label>
<!-- Card 3: Amigo Sincero -->
<label class="relative cursor-pointer group">
<input class="peer sr-only" name="mode" onchange="selectMode('amigo')" type="radio" value="amigo">
<div class="p-4 rounded-xl border-2 border-slate-200 peer-checked:border-teal-500 peer-checked:bg-teal-50 hover:bg-slate-50 transition-all h-full flex flex-col items-center text-center">
<div class="w-16 h-16 rounded-full overflow-hidden mb-3 ring-2 ring-offset-2 ring-transparent peer-checked:ring-teal-500 group-hover:scale-105 transition-transform">
<img alt="Amigo Sincero" class="w-full h-full object-cover" go-data-src="/gen?prompt=young+adult+rolling+eyes+and+shrugging+shoulders+wearing+casual+hoodie+cartoon+style&amp;aspect=1:1" src="blob:https://32v45e0920krbtm24xzwvf5h0mz2ml76zyfcwifhf7ofwv16ny-h845251650.scf.usercontent.goog/838765a3-f48e-4003-b189-c602f3b8a3ee" style="">
</div>
<div class="font-bold text-slate-800">Amigo Sincero</div>
<div class="text-xs text-slate-500 mt-1">Verdades &amp; Ironia</div>
</div>
</label>
</div>
</div>
<button class="w-full py-4 bg-indigo-600 hover:bg-indigo-700 text-white font-bold rounded-xl shadow-lg shadow-indigo-200 transition-all transform active:scale-[0.98] flex items-center justify-center gap-2 text-lg" onclick="generateAdvice()">
<span class="material-symbols-outlined">psychology_alt</span>
                                Me Ajuda (Mas Não Muito)
                            </button>
</div>
<!-- VIEW 2: Loading (Hidden) -->
<div class="hidden py-12 text-center" id="loading-section">
<div class="inline-block animate-spin rounded-full h-12 w-12 border-4 border-slate-200 border-t-indigo-600 mb-4"></div>
<p class="text-slate-600 font-medium animate-pulse" id="loading-text">Acessando o cosmos...</p>
</div>
<!-- VIEW 3: Result (Hidden) -->
<div class="hidden" id="result-section">
<!-- The Response Card -->
<div class="bg-slate-50 rounded-xl p-6 border border-slate-200 mb-6 relative overflow-hidden">
<!-- Background Icon Decoration -->
<span class="material-symbols-outlined absolute top-4 right-4 text-slate-200 text-6xl select-none -z-0">format_quote</span>
<div class="relative z-10 space-y-6">
<!-- Part 1: Roast -->
<div>
<div class="flex items-center gap-2 mb-2 text-red-600 font-bold text-xs uppercase tracking-wider">
<span class="material-symbols-outlined text-sm">local_fire_department</span> O Diagnóstico
                                        </div>
<p class="text-lg font-medium text-slate-800 italic" id="result-roast">"..."</p>
</div>
<hr class="border-slate-200">
<!-- Part 2: Advice -->
<div>
<div class="flex items-center gap-2 mb-2 text-indigo-600 font-bold text-xs uppercase tracking-wider">
<span class="material-symbols-outlined text-sm">lightbulb</span> O Conselho
                                        </div>
<p class="text-xl text-slate-900 font-bold leading-snug" id="result-advice">...</p>
</div>
<hr class="border-slate-200">
<!-- Part 3: Closing -->
<div>
<div class="flex items-center gap-2 mb-2 text-slate-500 font-bold text-xs uppercase tracking-wider">
<span class="material-symbols-outlined text-sm">waving_hand</span> Consideração Final
                                        </div>
<p class="text-slate-600" id="result-closing">...</p>
</div>
</div>
</div>
<!-- Action Buttons -->
<div class="flex gap-3">
<button class="flex-1 py-3 px-4 bg-white border border-slate-300 hover:bg-slate-50 text-slate-700 font-semibold rounded-lg transition-colors flex items-center justify-center gap-2" onclick="resetApp()">
<span class="material-symbols-outlined">refresh</span> Outro Problema
                                </button>
<button class="flex-1 py-3 px-4 bg-slate-900 hover:bg-slate-800 text-white font-semibold rounded-lg shadow-lg transition-colors flex items-center justify-center gap-2" onclick="shareResult()">
<span class="material-symbols-outlined">share</span> Compartilhar
                                </button>
</div>
</div>
</div>
</div>
<!-- Trust Indicators (Irony) -->
<div class="flex justify-center gap-8 mt-8 text-slate-400 grayscale opacity-70">
<div class="flex items-center gap-1"><span class="material-symbols-outlined">bolt</span> Ultra Rápido</div>
<div class="flex items-center gap-1"><span class="material-symbols-outlined">verified_user</span> 0% Útil</div>
<div class="flex items-center gap-1"><span class="material-symbols-outlined">lock</span> 100% Seguro</div>
</div>
</div>
</section>
<!-- Personas Explanation Section -->
<section class="py-20 bg-white border-y border-slate-100" id="modos">
<div class="container mx-auto px-4">
<div class="text-center mb-16">
<h2 class="text-3xl md:text-4xl font-bold mb-4 brand-font">Escolha Seu Veneno</h2>
<p class="text-slate-600 max-w-xl mx-auto">Três personalidades distintas prontas para ignorar seus sentimentos reais e focar no que realmente importa: memes.</p>
</div>
<div class="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
<!-- Tio Card -->
<div class="group p-6 rounded-2xl bg-slate-50 border border-slate-100 hover:border-orange-200 hover:shadow-xl hover:shadow-orange-100/50 transition-all duration-300">
<div class="w-16 h-16 bg-orange-100 rounded-2xl flex items-center justify-center text-orange-600 mb-6 group-hover:scale-110 transition-transform">
<span class="material-symbols-outlined text-3xl">skillet</span>
</div>
<h3 class="text-xl font-bold mb-3 text-slate-900">Tio do Churrasco</h3>
<p class="text-slate-600 mb-4">Senso comum misturado com gordura saturada. Ele resolve tudo com frases simples que começam com "na minha época".</p>
<ul class="text-sm text-slate-500 space-y-2">
<li class="flex items-center gap-2"><span class="material-symbols-outlined text-green-500 text-base">check</span> Soluções vagas</li>
<li class="flex items-center gap-2"><span class="material-symbols-outlined text-green-500 text-base">check</span> Analogias com carne</li>
<li class="flex items-center gap-2"><span class="material-symbols-outlined text-green-500 text-base">check</span> Piadas de pavê</li>
</ul>
</div>
<!-- Coach Card -->
<div class="group p-6 rounded-2xl bg-slate-50 border border-slate-100 hover:border-purple-200 hover:shadow-xl hover:shadow-purple-100/50 transition-all duration-300">
<div class="w-16 h-16 bg-purple-100 rounded-2xl flex items-center justify-center text-purple-600 mb-6 group-hover:scale-110 transition-transform">
<span class="material-symbols-outlined text-3xl">self_improvement</span>
</div>
<h3 class="text-xl font-bold mb-3 text-slate-900">Coach Quântico</h3>
<p class="text-slate-600 mb-4">Motivação vazia com buzzwords complexas. Ele vai reprogramar seu DNA para o sucesso (por R$ 1997,00).</p>
<ul class="text-sm text-slate-500 space-y-2">
<li class="flex items-center gap-2"><span class="material-symbols-outlined text-green-500 text-base">check</span> Mindset de crescimento</li>
<li class="flex items-center gap-2"><span class="material-symbols-outlined text-green-500 text-base">check</span> Física quântica (errada)</li>
<li class="flex items-center gap-2"><span class="material-symbols-outlined text-green-500 text-base">check</span> Gratidão tóxica</li>
</ul>
</div>
<!-- Amigo Card -->
<div class="group p-6 rounded-2xl bg-slate-50 border border-slate-100 hover:border-teal-200 hover:shadow-xl hover:shadow-teal-100/50 transition-all duration-300">
<div class="w-16 h-16 bg-teal-100 rounded-2xl flex items-center justify-center text-teal-600 mb-6 group-hover:scale-110 transition-transform">
<span class="material-symbols-outlined text-3xl">sentiment_satisfied</span>
</div>
<h3 class="text-xl font-bold mb-3 text-slate-900">Amigo Sincero</h3>
<p class="text-slate-600 mb-4">Aquele que te avisa que você tem feijão no dente. Direto, um pouco irônico, mas no fundo só quer rir com você.</p>
<ul class="text-sm text-slate-500 space-y-2">
<li class="flex items-center gap-2"><span class="material-symbols-outlined text-green-500 text-base">check</span> Realidade nua e crua</li>
<li class="flex items-center gap-2"><span class="material-symbols-outlined text-green-500 text-base">check</span> Ironia fina</li>
<li class="flex items-center gap-2"><span class="material-symbols-outlined text-green-500 text-base">check</span> Zero paciência</li>
</ul>
</div>
</div>
</div>
</section>
<!-- Technical Footer/Architecture (from files) -->
<section class="py-16 bg-slate-900 text-slate-300" id="tech">
<div class="container mx-auto px-4">
<div class="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
<div>
<h2 class="text-2xl font-bold text-white mb-6 brand-font">Sob o Capô</h2>
<p class="mb-6 leading-relaxed">
                            Construído seguindo os padrões de 2026 (porque somos futuristas). 
                            Focado em performance, SEO e em entregar respostas inúteis o mais rápido possível.
                        </p>
<div class="flex flex-wrap gap-3">
<span class="px-3 py-1 bg-slate-800 rounded-full text-xs font-mono text-cyan-400 border border-slate-700">Next.js 16+</span>
<span class="px-3 py-1 bg-slate-800 rounded-full text-xs font-mono text-sky-400 border border-slate-700">Tailwind CSS 4</span>
<span class="px-3 py-1 bg-slate-800 rounded-full text-xs font-mono text-orange-400 border border-slate-700">Cloudflare Workers</span>
<span class="px-3 py-1 bg-slate-800 rounded-full text-xs font-mono text-green-400 border border-slate-700">Supabase</span>
</div>
</div>
<!-- Code Snippet Decoration -->
<div class="bg-slate-800 p-6 rounded-xl border border-slate-700 font-mono text-sm shadow-2xl">
...
<p><span class="text-purple-400">const</span> <span class="text-blue-400">flow</span> = <span class="text-yellow-300">{</span></p>
<p class="pl-4">user: <span class="text-green-400">'Next.js'</span>,</p>
<p class="pl-4">processing: <span class="text-green-400">'Cloudflare Worker'</span>,</p>
<p class="pl-4">llm: <span class="text-green-400">'Ignorância Artificial'</span>,</p>
<p class="pl-4">db: <span class="text-green-400">'Supabase Postgres'</span>,</p>
<p class="pl-4">cache: <span class="text-green-400">'Redis'</span></p>
<p><span class="text-yellow-300">}</span>;</p>
<p class="text-slate-500">// Otimizado para LCP, CLS e risadas rápidas.</p>
</div>
</div>
</div>
</div>
...
<footer class="bg-slate-950 py-8 text-center text-slate-500 text-sm border-t border-slate-900">
<div class="container mx-auto px-4">
<p class="mb-2">© 2026 Te Ajudo, Mas Não Muito. Todos os direitos reservados (ou não).</p>
...
<script>
        ...
        const modes = {
            tio: {
                loading: ["Acendendo a churrasqueira...", "Procurando o sal grosso...", "Gelando a cerveja...", "Perguntando pro vizinho..."],
                roasts: [
                    "Você tá muito tenso, sobrinho. Isso é falta de proteína.",
                    "Na minha época a gente resolvia isso no braço, não no choro.",
                    "Esse seu problema aí é menor que carvão de dois dias.",
                    "Você complica demais o que é simples. Parece sua tia Claudete."
                ],
                advices: [
                    "Faz um churrasco que passa.",
                    "Arruma um lote pra capinar que a cabeça esfria.",
                    "Toma uma gelada e bota um Raça Negra pra tocar.",
                    "Ignora. Se não sangrar, não é grave."
                ],
                closings: [
                    "E vê se traz a picanha na próxima.",
                    "Se cuida, campeão.",
                    "É pavê ou pra comer? Kkkkk.",
                    "Forte abraço."
                ]
            },
            coach: {
                loading: ["Alinhando chakras...", "Consultando o vórtice quântico...", "Ressignificando a espera...", "Baixando o download cósmico..."],
                roasts: [
                    "Sua vibração está em 2Hz. Muito baixa para o sucesso.",
                    "Você está preso no mindset de escassez da Matrix.",
                    "Seu DNA quântico grita 'mediocridade' nesse momento.",
                    "Você é o CEO da sua própria derrota com essa atitude."
                ],
                advices: [
                    "Visualize o sucesso enquanto toma banho gelado às 3h da manhã.",
                    "Reprograme suas crenças limitantes gritando no espelho.",
                    "Solte para o universo e compre meu curso de 12x de R$99.",
                    "Apenas seja. O fazer é para os fracos. O ser é quântico."
                ],
                closings: [
                    "Namastê, high stakes.",
                    "Foguete não tem ré (mas explode).",
                    "Gratiluz.",
                    "Te vejo no topo (ou não)."
                ]
            },
            amigo: {
                loading: ["Revirando os olhos...", "Preparando a verdade...", "Digitando...", "Respirando fundo..."],
                roasts: [
                    "Amigo, você não se ajuda, né?",
                    "Seu dedo podre para escolhas devia ser estudado pela NASA.",
                    "Sério que você tá sofrendo por isso? De novo?",
                    "Você tem o talento incrível de criar problema onde não tem."
                ],
                advices: [
                    "Para de mandar mensagem pra ex. É sério.",
                    "Aceita que dói menos e segue o baile.",
                    "Vai dormir. Amanhã você faz merda de novo com a cabeça fresca.",
                    "Bloqueia e finge demência."
                ],
                closings: [
                    "Tamo junto na lama.",
                    "Depois a gente bebe uma.",
                    "Qualquer coisa, não me liga.",
                    "Juízo (que você não tem)."
                ]
            }
        };
        ...
        const randomSituations = [
            ...
            "Mandei mensagem pra ex bêbado.",
            "Gastei todo meu salário em ifood.",
            "Estou apaixonado pela pessoa errada."
        ];

        let currentMode = 'coach'; // Default based on HTML
        ...
        function fillRandom() {
            ...
            situationInput.value = random;
        }

        function generateAdvice() {
            const input = document.getElementById('situation').value.trim();
            if (!input) {
                alert("Escreva alguma coisa pra gente poder te julgar.");
                return;
            }
            ...
            // Set random loading text based on mode
            const loadingTexts = modes[currentMode].loading;
            document.getElementById('loading-text').innerText = loadingTexts[Math.floor(Math.random() * loadingTexts.length)];

            // Simulate API Network Delay (1.5s)
            setTimeout(() => {
                const data = modes[currentMode];
                
                // Pick random contents (Simulating LLM response)
                const roast = data.roasts[Math.floor(Math.random() * data.roasts.length)];
                const advice = data.advices[Math.floor(Math.random() * data.advices.length)];
                const closing = data.closings[Math.floor(Math.random() * data.closings.length)];

                // Update DOM
                document.getElementById('result-roast').innerText = `"${roast}"`;
                document.getElementById('result-advice').innerText = advice;
                document.getElementById('result-closing').innerText = closing;

                // Show Result
                document.getElementById('loading-section').classList.add('hidden');
                document.getElementById('result-section').classList.remove('hidden');
                document.getElementById('result-section').classList.add('animate-fade-in');
        ...
        function resetApp() {
            ...
            document.getElementById('input-section').classList.add('animate-fade-in');
        }

        function shareResult() {
            const roast = document.getElementById('result-roast').innerText;
            const advice = document.getElementById('result-advice').innerText;
            const text = `Te Ajudo, Mas Não Muito me disse:\n${roast}\nConselho: ${advice}`;
            
            if (navigator.share) {
                navigator.share({
                    title: 'Te Ajudo, Mas Não Muito',
                    text: text,
                    url: window.location.href,
                }).catch(console.error);
            } else {
                navigator.clipboard.writeText(text);
                alert("Copiado para a área de transferência! (Já que seu navegador é velho e não compartilha direto)");
            }
        }
    </script>
<!--
"/gen?prompt=middle+aged+brazilian+man+wearing+sunglasses+and+soccer+jersey+holding+a+bbq+skewer+smiling+cartoon+style&aspect=1:1"
"/gen?prompt=man+in+business+suit+levitating+in+space+with+glowing+geometry+symbols+around+head+cartoon+style&aspect=1:1"
"/gen?prompt=young+adult+rolling+eyes+and+shrugging+shoulders+wearing+casual+hoodie+cartoon+style&aspect=1:1"
-->
